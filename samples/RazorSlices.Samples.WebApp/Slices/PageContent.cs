...
{
    public static ReadOnlySpan<byte> SentenceUtf8 => "Lorem ipsum dolor sit amet ipsum sed feugiat rebum et voluptua autem dolore amet magna."u8;

    public static string Sentence => "Lorem ipsum dolor sit amet ipsum sed feugiat rebum et voluptua autem dolore amet magna.";

    public static ReadOnlySpan<byte> SentencesUtf8(int count)
    {
        if (count == 1)
        {
            return SentenceUtf8;
